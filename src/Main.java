...
public class Main {
	...
	public static void main(String[] args) {
		...
		Produto produto2 = new Produto(2, "Croissant", 7, 6.50, empresa);		 
		Produto produto3 = new Produto(3, "Sonho", 5, 8.50, empresa);
		Produto produto4 = new Produto(4, "Chá Gelado", 4, 5.50, empresa);
		Produto produto5 = new Produto(5, "Coturno", 10, 400.0, empresa2);
		Produto produto6 = new Produto(6, "Jaqueta Jeans", 15, 150.0, empresa2);
		Produto produto7 = new Produto(7, "Calça Sarja", 15, 150.0, empresa2);
						...
						vendas.stream().forEach(venda -> {
							if (venda.getEmpresa().getId().equals(usuarioLogado.getEmpresa().getId())) {
								...
								System.out.println("Venda de código: " + venda.getCódigo() + " no CPF "
										+ venda.getCliente().getCpf() + ": " + "nome do cliente: " + venda.getCliente().getNome());
